# _approve-spec Skill Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a shared `_approve-spec` skill that both Claude and Codex install, so invoking it tells the agent the spec is approved, implementation should proceed, and a PR should be opened when the work is complete.
...
**Spec:** `docs/superpowers/specs/2026-04-20-_approve-spec-skill-design.md`

**File map:**
- `tests/_approve-spec-skill.sh` — repo-level regression for the new shared skill source, wording, and packaging shape.
- `roles/common/files/config/skills/common/_approve-spec/SKILL.md` — new shared skill installed into both Claude and Codex.
- `docs/superpowers/plans/2026-04-20-_approve-spec-skill.md` — living implementation record for this work.
...
**Files:**
- Create: `tests/_approve-spec-skill.sh`
- Test: `bash tests/_approve-spec-skill.sh`

- [x] **Step 1.1: Create the failing regression script**

Create `tests/_approve-spec-skill.sh` with this exact content, then mark it executable with `chmod +x tests/_approve-spec-skill.sh`:
...
COMMON_SKILL="$REPO_ROOT/roles/common/files/config/skills/common/_approve-spec/SKILL.md"
CLAUDE_SKILL_DIR="$REPO_ROOT/roles/common/files/config/skills/claude/_approve-spec"
CODEX_SKILL_DIR="$REPO_ROOT/roles/common/files/config/skills/codex/_approve-spec"
...
assert_exists "$COMMON_SKILL" "shared _approve-spec skill exists"
assert_missing "$CLAUDE_SKILL_DIR" "no Claude-specific _approve-spec override"
assert_missing "$CODEX_SKILL_DIR" "no Codex-specific _approve-spec override"

assert_contains "$COMMON_SKILL" "name: _approve-spec" "skill uses canonical name"
...
```bash
bash tests/_approve-spec-skill.sh
```
...
```bash
git add tests/_approve-spec-skill.sh docs/superpowers/plans/2026-04-20-_approve-spec-skill.md
git commit -m "Add _approve-spec regression plan"
```
...
### Task 2: Create the shared `_approve-spec` skill

**Files:**
- Create: `roles/common/files/config/skills/common/_approve-spec/SKILL.md`
- Test: `bash tests/_approve-spec-skill.sh`

- [x] **Step 2.1: Create the shared skill with the approved wording**

Create `roles/common/files/config/skills/common/_approve-spec/SKILL.md` with this exact content:
...
```bash
git add roles/common/files/config/skills/common/_approve-spec/SKILL.md tests/_approve-spec-skill.sh docs/superpowers/plans/2026-04-20-_approve-spec-skill.md
git commit -m "Add shared _approve-spec skill"
```
...
**Files:**
- Reference: `roles/common/files/config/skills/common/_approve-spec/SKILL.md`
- Reference: `~/.claude/skills/_approve-spec/SKILL.md`
- Reference: `~/.codex/skills/_approve-spec/SKILL.md`
...
```bash
rg -n -F "name: _approve-spec" ~/.claude/skills/_approve-spec/SKILL.md ~/.codex/skills/_approve-spec/SKILL.md
rg -n -F "The spec is approved." ~/.claude/skills/_approve-spec/SKILL.md ~/.codex/skills/_approve-spec/SKILL.md
rg -n -F "Please proceed with implementation immediately." ~/.claude/skills/_approve-spec/SKILL.md ~/.codex/skills/_approve-spec/SKILL.md
rg -n -F "open a PR" ~/.claude/skills/_approve-spec/SKILL.md ~/.codex/skills/_approve-spec/SKILL.md
```
...
**Files:**
- Reference: `docs/superpowers/specs/2026-04-20-_approve-spec-skill-design.md`
- Reference: `docs/superpowers/plans/2026-04-20-_approve-spec-skill.md`
- Reference: `tests/_approve-spec-skill.sh`
- Reference: `roles/common/files/config/skills/common/_approve-spec/SKILL.md`
...
```text
- roles/common/files/config/skills/common/_approve-spec/SKILL.md exists
- no runtime-specific _approve-spec skill directory exists under roles/common/files/config/skills/claude or codex
