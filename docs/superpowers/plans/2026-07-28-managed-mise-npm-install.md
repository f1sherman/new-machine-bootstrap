...
Create a Ruby test that extracts the task beginning `- name: Install managed mise npm tools through aube` and ending at the next task. Require these fragments:
