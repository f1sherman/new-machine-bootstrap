...
* Branch/worktree lifecycle: start with `repo-start <branch>`. Created other way: run `tmux-agent-worktree set <absolute-path>`. After the PR has merged, run `repo-end` to clean up the worktree/branch.
