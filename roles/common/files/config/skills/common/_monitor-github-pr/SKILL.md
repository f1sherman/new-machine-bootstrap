---
name: _monitor-github-pr
description: Run one blocking GitHub PR monitor pass and return actionable or terminal JSON for `_monitor-pr`.
---
...
2. Switch into `REPO_DIR` and run:
   ...
   bash ~/.local/share/skills/_pr-monitor/run.sh \
     ...
     --state-cmd ~/.local/share/skills/_pr-github/state.sh \
     --comments-cmd ~/.local/share/skills/_pr-github/comments.sh \
