...
During an active merge, the commit helper automatically bypasses local commit hooks. Do not run separate validation only to satisfy those hooks; rely on completed validation and CI.
