...
assert_line "$MAIN_YML" "roles/common/files/config/skills/common/" "Ansible still installs common skills"
assert_line "$MAIN_YML" ".claude/skills/" "Ansible installs skills into Claude"
assert_line "$MAIN_YML" ".codex/skills/" "Ansible installs skills into Codex"
