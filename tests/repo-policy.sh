...
run_install_checks() {
  ...
  assert_not_contains "$SETUP" "disablesleep" "macOS setup does not disable sleep system-wide"
  ...
  assert_not_contains "$PLAYBOOK" "disablesleep" "playbook does not require system-wide disablesleep"
